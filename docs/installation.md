...
For Windows, download `dent8-v0.3.1-x86_64-pc-windows-msvc.zip` and its `.sha256`, verify
...
provenance matters. Remote HTTP/streamable MCP is future work, not part of the `0.3.1`
release.
