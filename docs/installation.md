...
For Windows, download `dent8-v0.6.0-x86_64-pc-windows-msvc.zip` and its `.sha256`, verify
...
provenance matters. Remote HTTP/streamable MCP is future work, not part of the `0.6.0`
release.
