...
[`evals/traces/`](evals/traces/). Five reviewed, redacted maintainer-dogfood traces now ship
(Claude Code, Cursor, Grok Build, multi-op CLI, multi-agent team: **13** legitimate operations,
0 false positives); no independent captured-user tally is claimed yet. Gate with
