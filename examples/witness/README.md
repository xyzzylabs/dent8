...
Publish the output of `dent8 witness head` somewhere the writer cannot rewrite. Without that
external publication, a local witness log can still be rolled back by someone who controls the
same storage.
